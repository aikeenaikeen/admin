...
export const RECOMMENDED_RECOGNITION_CONFIG: RecognitionConfig = {
  ...
  actionRecognition: {
    ...
    qualityGate: {
      ...
      minCropWidth: 64,
      minCropHeight: 96,
      minCropAreaRatio: 0.006,
      minSharpness: 10,
      maxEdgeTouchRatio: 0.55,
    },
    temporalGate: {
      enabled: true,
      windowFrames: 5,
      minPositiveFrames: 3,
      rejectCooldownSeconds: 4,
    },
    trackGuard: {
      enabled: true,
      minTrackAgeSeconds: 0.25,
      minTrackConsecutiveUpdates: 2,
      maxBBoxJumpRatio: 0.9,
      resetOnTrackSwitch: true,
      resetOnAssignmentChange: true,
    },
    vlmVerifier: {
      enabled: false,
      minActionScore: 0.55,
    ...
    diagnostics: {
      keepRecentDecisions: true,
      recentDecisionLimit: 300,
    },
...
export const RECOGNITION_FIELD_META: Readonly<Record<string, FieldMeta>> = {
  ...
  actionScoreSmoothingAlpha: {
    min: 0,
    max: 1,
    recommended: 0.35,
    descriptionKey: 'companies.dialog.hints.actionScoreSmoothingAlpha',
  },
  actionGapSeconds: {
    min: 0.1,
    max: 30,
  ...
  actionQualityGateEnabled: {
    recommended: true,
    descriptionKey: 'companies.dialog.hints.actionQualityGateEnabled',
  },
  actionQualityGateMinCropWidth: {
    min: 32,
    max: 640,
    recommended: 64,
    descriptionKey: 'companies.dialog.hints.actionQualityGateMinCropWidth',
  },
  actionQualityGateMinCropHeight: {
    min: 48,
    max: 640,
    recommended: 96,
    descriptionKey: 'companies.dialog.hints.actionQualityGateMinCropHeight',
  },
  actionQualityGateMinCropAreaRatio: {
    min: 0,
    max: 0.5,
    recommended: 0.006,
    descriptionKey: 'companies.dialog.hints.actionQualityGateMinCropAreaRatio',
  },
  actionQualityGateMinSharpness: {
    min: 0,
    max: 500,
    recommended: 10,
    descriptionKey: 'companies.dialog.hints.actionQualityGateMinSharpness',
  },
  actionQualityGateMaxEdgeTouchRatio: {
    min: 0,
    max: 1,
    recommended: 0.55,
    descriptionKey: 'companies.dialog.hints.actionQualityGateMaxEdgeTouchRatio',
  },
  actionTemporalGateEnabled: {
    recommended: true,
    descriptionKey: 'companies.dialog.hints.actionTemporalGateEnabled',
  },
  actionTemporalGateWindowFrames: {
    min: 1,
    max: 20,
    recommended: 5,
    descriptionKey: 'companies.dialog.hints.actionTemporalGateWindowFrames',
  },
  actionTemporalGateMinPositiveFrames: {
    min: 1,
    max: 20,
    recommended: 3,
    descriptionKey: 'companies.dialog.hints.actionTemporalGateMinPositiveFrames',
  },
  actionTemporalGateRejectCooldownSeconds: {
    min: 0,
    max: 120,
    recommended: 4,
    descriptionKey: 'companies.dialog.hints.actionTemporalGateRejectCooldownSeconds',
  },
  actionTrackGuardEnabled: {
    recommended: true,
    descriptionKey: 'companies.dialog.hints.actionTrackGuardEnabled',
  },
  actionTrackGuardMinTrackAgeSeconds: {
    min: 0,
    max: 30,
    recommended: 0.25,
    descriptionKey: 'companies.dialog.hints.actionTrackGuardMinTrackAgeSeconds',
  },
  actionTrackGuardMinTrackConsecutiveUpdates: {
    min: 1,
    max: 30,
    recommended: 2,
    descriptionKey: 'companies.dialog.hints.actionTrackGuardMinTrackConsecutiveUpdates',
  },
  actionTrackGuardMaxBBoxJumpRatio: {
    min: 0,
    max: 5,
    recommended: 0.9,
    descriptionKey: 'companies.dialog.hints.actionTrackGuardMaxBBoxJumpRatio',
  },
  actionTrackGuardResetOnTrackSwitch: {
    recommended: true,
    descriptionKey: 'companies.dialog.hints.actionTrackGuardResetOnTrackSwitch',
  },
  actionTrackGuardResetOnAssignmentChange: {
    recommended: true,
    descriptionKey: 'companies.dialog.hints.actionTrackGuardResetOnAssignmentChange',
  },
  actionVlmEnabled: {
    recommended: false,
  ...
  actionDiagnosticsKeepRecentDecisions: {
    recommended: true,
    descriptionKey: 'companies.dialog.hints.actionDiagnosticsKeepRecentDecisions',
  },
  actionDiagnosticsRecentDecisionLimit: {
    min: 50,
    max: 5000,
    recommended: 300,
    descriptionKey: 'companies.dialog.hints.actionDiagnosticsRecentDecisionLimit',
  },
  actionDebug: {
    recommended: false,
